...
# Setup Djong REST framework and test the REST API endpoints
...
3. Test the API endpoints using curl command. (See <attachments> above for file contents. You may not need to search or read the file again.)
